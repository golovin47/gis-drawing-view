...
object Version {
    ...
    const val androidKtx = "1.0.0"   //https://github.com/android/android-ktx
    const val androidLifecycle = "2.0.0-rc01"
    const val multidex = "2.0.0"
    const val constraintLayout = "1.1.2"

    // kotlin
    const val kotlin = "1.3.21" // https://kotlinlang.org/
...
object Deps {
    ...
    // Android
    const val androidCore = "androidx.core:core:${Version.androidXCore}"
